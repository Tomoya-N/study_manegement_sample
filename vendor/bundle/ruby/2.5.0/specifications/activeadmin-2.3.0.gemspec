# -*- encoding: utf-8 -*-
# stub: activeadmin 2.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<arbre>.freeze, [">= 1.2.1", "~> 1.2"])
      ...
      s.add_runtime_dependency(%q<kaminari>.freeze, [">= 1.0.1", "~> 1.0"])
      s.add_runtime_dependency(%q<railties>.freeze, ["< 6.1", ">= 5.0"])
      s.add_runtime_dependency(%q<ransack>.freeze, ["~> 2.3"])
      s.add_runtime_dependency(%q<sassc-rails>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<sprockets>.freeze, ["< 4.1", ">= 3.0"])
      s.add_runtime_dependency(%q<sprockets-es6>.freeze, [">= 0.9.2", "~> 0.9"])
    else
      s.add_dependency(%q<arbre>.freeze, [">= 1.2.1", "~> 1.2"])
      ...
      s.add_dependency(%q<kaminari>.freeze, [">= 1.0.1", "~> 1.0"])
      s.add_dependency(%q<railties>.freeze, ["< 6.1", ">= 5.0"])
      s.add_dependency(%q<ransack>.freeze, ["~> 2.3"])
      s.add_dependency(%q<sassc-rails>.freeze, ["~> 2.1"])
      s.add_dependency(%q<sprockets>.freeze, ["< 4.1", ">= 3.0"])
      s.add_dependency(%q<sprockets-es6>.freeze, [">= 0.9.2", "~> 0.9"])
    end
  else
    s.add_dependency(%q<arbre>.freeze, [">= 1.2.1", "~> 1.2"])
    s.add_dependency(%q<formtastic>.freeze, ["~> 3.1"])
